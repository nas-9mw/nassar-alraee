...
export const digitalBrief: BriefConfig = {
  ...
  sections: [
    clientInfoSection,
    {
      ...
      title: 'عن المشروع',
      fields: [
        { id: 'productName', label: 'إيش اسم منتجك أو خدمتك؟', type: 'text', required: true, placeholder: 'مثال: متجر نون للعطور' },
        { id: 'productDescription', label: 'إيش تبيع بالضبط؟ اشرحه بإختصار', type: 'textarea', required: true, placeholder: 'وصف مختصر للمنتج/الخدمة وأهم مميزاته' },
        { id: 'website', label: 'عندك موقع أو حسابات سوشيال شغّالة؟', type: 'text', placeholder: 'الرابط أو اسم اليوزر (اختياري)' },
      ],
    },
    {
      id: 'goal',
      title: 'الهدف من الحملة',
      fields: [
        {
          id: 'campaignGoal',
          label: 'إيش الهدف الأساسي من التسويق؟',
          type: 'single',
          options: ['زيادة المبيعات', 'جذب عملاء محتملين (Leads)', 'زيادة الوعي بالعلامة', 'زيادة المتابعين والتفاعل', 'إطلاق منتج جديد', 'أخرى'],
          required: true,
        },
        {
          id: 'successMetric',
          label: 'كيف تقيس نجاح الحملة؟',
          type: 'multi',
          options: ['عدد المبيعات', 'عدد الطلبات/الحجوزات', 'تكلفة العميل (CPA)', 'عدد المتابعين', 'نسبة التفاعل', 'زيارات الموقع'],
          required: true,
        },
      ],
    },
    {
      ...
      title: 'الجمهور المستهدف',
      fields: [
        { id: 'targetAudience', label: 'مين جمهورك المستهدف؟', type: 'textarea', required: true, placeholder: 'مثال: نساء عاملات يهتمن بالعناية الشخصية' },
        { id: 'targetAge', label: 'الفئة العمرية', type: 'multi', options: ['أقل من 18', '18-24', '25-34', '35-44', '45+'], required: true },
        { id: 'targetGender', label: 'الجنس', type: 'single', options: ['ذكر', 'أنثى', 'كلاهما'], required: true },
        { id: 'targetLocation', label: 'وين موقعهم الجغرافي؟', type: 'text', required: true, placeholder: 'مدن/دول محددة أو الخليج عموماً' },
      ],
    },
    {
      id: 'product',
      title: 'المنتج وقيمته',
      fields: [
        { id: 'productAdvantage', label: 'إيش اللي يميز منتجك عن غيره؟', type: 'textarea', required: true },
        { id: 'whyBuy', label: 'ليش العميل يختارك أنت بالذات؟', type: 'textarea', required: true },
        { id: 'priceRange', label: 'النطاق السعري للمنتج/الخدمة', type: 'single', options: ['اقتصادي', 'متوسط', 'مرتفع', 'فاخر'], required: true },
      ],
    },
    {
      id: 'competitors',
      title: 'المنافسين',
      fields: [
        { id: 'competitors', label: 'مين أبرز منافسينك؟', type: 'textarea', required: true, placeholder: 'اذكر 2-3 منافسين بالأسماء أو الحسابات' },
    ...
    },
    {
      ...
      fields: [
        {
          id: 'platforms',
          label: 'وين تحب تسوّق منتجك؟',
          type: 'multi',
          options: ['انستقرام', 'تيك توك', 'سناب شات', 'تويتر/X', 'فيسبوك', 'يوتيوب', 'قوقل (إعلانات بحث)', 'سناب مابس', 'واتساب', 'مؤثرين'],
          required: true,
        },
        {
          id: 'contentType',
          label: 'إيش نوع المحتوى اللي تفضله؟',
          type: 'multi',
          options: ['فيديوهات قصيرة (Reels/TikTok)', 'صور تصاميم', 'مقالات/منشورات', 'إعلانات مدفوعة', 'تعاون مع مؤثرين', 'لا أعرف، أحتاج توصية'],
        },
      ],
    },
    {
      id: 'budget',
      title: 'الميزانية والتوقيت',
      fields: [
        {
          id: 'adBudget',
          label: 'كم ميزانيتك التسويقية الشهرية؟',
          type: 'single',
          options: ['أقل من 1000 ريال', '1000-3000 ريال', '3000-7000 ريال', '7000-15000 ريال', 'أكثر من 15000 ريال'],
          required: true,
        },
        { id: 'startDate', label: 'متى تبي تبدأ الحملة؟', type: 'text', required: true, placeholder: 'مثال: خلال أسبوع، بداية الشهر القادم' },
        { id: 'campaignDuration', label: 'مدة الحملة المتوقعة', type: 'single', options: ['أقل من شهر', '1-3 أشهر', '3-6 أشهر', 'مستمرة طويلة المدى'], required: true },
      ],
    },
    {
      id: 'extras',
      ...
      fields: [
        { id: 'previousExperience', label: 'هل سبق وجربت تسويق إلكتروني من قبل؟', type: 'single', options: ['نعم وكانت ناجحة', 'نعم لكن ما أعطت نتيجة', 'لا، أول تجربة'], required: true },
        { id: 'notes', label: 'أي شي تحب تضيفه؟', type: 'textarea', placeholder: 'تفاصيل، أفكار، تحديات، أو توقعات خاصة' },
      ],
    },
  ],
};
