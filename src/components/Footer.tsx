      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-black text-white">نصّار<span className="text-red-500">.</span></span>
          </div>
          <p className="text-white/30 text-sm text-center">© {new Date().getFullYear()} نصّار. جميع الحقوق محفوظة</p>
          <div className="flex gap-3">
            <a href="#" className="text-white/30 hover:text-red-400 transition-colors" aria-label="تويتر">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="#" className="text-white/30 hover:text-red-400 transition-colors" aria-label="انستقرام">
